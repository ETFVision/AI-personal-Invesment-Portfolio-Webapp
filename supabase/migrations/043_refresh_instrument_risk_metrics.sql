-- Calculate instrument risk metrics in Postgres from stored instrument_prices.
-- This keeps instrument detail pages on derived reads instead of page-load calculations.
