...
2. Exact recommendation component weights by instrument type
   - Follow up in type-specific recommendation services.
   - `RecommendationRulesService.ts` documents generic thresholds and guardrails, but type-specific component weights need a table.

3. Exact portfolio TWR formula
...
5. Alpha branch feature gate audit
...
4. Fundamentals score formula
   - Produce a table for valuation, profitability, growth, quality, balance sheet, and trend score composition.

5. Risk score formula
   - Produce a formula table for risk buckets and final risk score from volatility/drawdown/downside metrics.
