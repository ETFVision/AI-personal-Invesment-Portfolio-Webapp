...
| 4 | Security Master Audit | Completed | Canonical securities, identifiers, aliases, internal ETF underlyings, issuer master, dual-run QA, issuer-level look-through rollups, Phase 5 stable identity propagation, Phase 8 monitoring, Phase 6 corporate-action readiness, Phase 7 provider-reconciliation readiness, and expanded generic issuer-name normalisation are implemented. Updated QA (2026-06-18, migration 112): 306/306 selectable instruments mapped, 169/169 ETF holdings mapped, 0 unmapped/ambiguous holdings, 5 mapping gap rows (expected identifier gaps only). |
