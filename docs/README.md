...
| Instrument taxonomy | Completed for current universe | `INSTRUMENT_TAXONOMY_AND_COVERAGE.md`, `INSTRUMENT_TAXONOMY_AUDIT.md`, `COMMERCIALIZATION_AUDIT_PLAN.md` | Current live target is 391 active user-selectable instruments: 232 ETF-style products and 159 stocks (after the 2026-06-23 expansion). Raw crypto references remain inactive. |
