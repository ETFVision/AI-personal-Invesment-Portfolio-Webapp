...
| Security Master QA | `security_master_mapping_gap_report`, `get_security_master_health_snapshot()` | Admin/Data Sources monitoring for mapping gaps, stale identifiers, recommendation/telemetry identity coverage, corporate-action readiness and provider-conflict readiness. | 391/391 selectable instruments mapped (2026-06-23 expansion) |
