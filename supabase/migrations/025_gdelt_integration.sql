...
values
  ('macro_rates_policy', 'Macro / rates policy', '("Federal Reserve" OR "interest rates" OR "Treasury yields")', 'Rates', 'macro_rates', true, 8),
  ('inflation_prices', 'Inflation and prices', '(inflation OR CPI OR "PCE inflation")', 'Inflation', 'inflation', true, 8),
  ('growth_recession', 'Growth / recession risk', '("recession risk" OR "economic slowdown" OR "jobs report")', 'Growth', 'growth', true, 8),
  ('currency_usd', 'Currency / USD', '("US dollar" OR "dollar index" OR "currency markets")', 'Currency', 'currency', true, 8),
  ('geopolitical_risk', 'Geopolitical risk', '(sanctions OR war OR conflict OR "military escalation")', 'Geopolitical', 'geopolitical', true, 8),
  ('trade_supply_chain', 'Trade / supply chain', '(tariffs OR "export controls" OR "supply chain")', 'Trade / Supply Chain', 'trade_supply_chain', true, 8),
  ('energy_commodities', 'Energy / commodities', '("oil prices" OR OPEC OR "natural gas")', 'Energy', 'energy_commodities', true, 8),
  ('global_credit_stress', 'Global risk / credit stress', '("banking stress" OR "sovereign debt" OR "credit stress")', 'Credit', 'global_credit', true, 8)
