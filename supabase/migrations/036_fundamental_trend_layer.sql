...
create table if not exists fundamental_trends (
  ...
  short_term_trend_direction text not null check (short_term_trend_direction in ('improving', 'stable', 'deteriorating', 'volatile', 'mixed', 'insufficient_data')),
  short_term_trend_strength text not null check (short_term_trend_strength in ('weak', 'moderate', 'strong', 'insufficient_data')),
  short_term_trend_score numeric(10, 4),
  short_term_confidence_score numeric(10, 4) not null default 0,
  long_term_trend_direction text not null check (long_term_trend_direction in ('improving', 'stable', 'deteriorating', 'volatile', 'mixed', 'insufficient_data')),
  long_term_trend_strength text not null check (long_term_trend_strength in ('weak', 'moderate', 'strong', 'insufficient_data')),
  long_term_trend_score numeric(10, 4),
  long_term_confidence_score numeric(10, 4) not null default 0,
  overall_trend_direction text not null check (overall_trend_direction in ('improving', 'stable', 'deteriorating', 'volatile', 'mixed', 'insufficient_data')),
