...
const componentCalculationRows = [
  ...
  ["Momentum", "Starts at 50. Adds clamp(YTD return x 40, -15, 15) and clamp(daily return x 80, -5, 5). Final value is clamped to 0-100. ETF 1-year return is excluded here because it is measured separately in Benchmark Relative."],
  ...
  ["ETF benchmark relative", "Score = 50 + winsorized(excess 1-year return vs external benchmark, +/-50 percentage points) x 200, clamped to 0-100. Benchmark parity scores 50; missing benchmark snapshots or one-year returns exclude the component. Map: US broad/sector/style ETFs use sp500; global equity uses global_equities; developed ex-US uses developed_ex_us; emerging markets uses emerging_markets; bonds/cash equivalents use us_aggregate_bonds; commodity/gold uses gold; crypto ETFs use bitcoin. Constants are fixed anchors, not refit per refresh."],
