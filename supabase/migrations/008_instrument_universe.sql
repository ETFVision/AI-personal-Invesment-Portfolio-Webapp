...
values
  ...
  ('BTC', 'Bitcoin', 'crypto', 'crypto', 'Digital Assets', 'Crypto', 'Global', 'USD', 'Crypto', null, '["bitcoin"]'::jsonb, '["store-of-value"]'::jsonb, 'crypto', 'high', null, null, null, null, 'Global', null, null, null, 'store-of-value', 'store-of-value', null, '{"chain":"Bitcoin"}'::jsonb, true, 'seeded'),
  ('ETH', 'Ethereum', 'crypto', 'crypto', 'Digital Assets', 'Crypto', 'Global', 'USD', 'Crypto', null, '[]'::jsonb, '["smart-contract"]'::jsonb, 'crypto', 'high', null, null, null, null, 'Global', null, null, null, 'smart-contract', 'smart-contract', null, '{"chain":"Ethereum"}'::jsonb, true, 'seeded'),
  ('SOL', 'Solana', 'crypto', 'crypto', 'Digital Assets', 'Crypto', 'Global', 'USD', 'Crypto', null, '[]'::jsonb, '["smart-contract"]'::jsonb, 'crypto', 'high', null, null, null, null, 'Global', null, null, null, 'smart-contract', 'smart-contract', null, '{"chain":"Solana"}'::jsonb, true, 'seeded'),
