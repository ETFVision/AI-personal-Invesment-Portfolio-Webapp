-- Add fixed-period drawdowns for instrument risk metrics.
-- Existing current_drawdown/max_drawdown remain "stored history" drawdowns.

alter table instrument_risk_metrics
  add column if not exists current_drawdown_1y numeric(28, 10),
  add column if not exists max_drawdown_1y numeric(28, 10),
  add column if not exists current_drawdown_3y numeric(28, 10),
  add column if not exists max_drawdown_3y numeric(28, 10),
  add column if not exists current_drawdown_5y numeric(28, 10),
  add column if not exists max_drawdown_5y numeric(28, 10);
...
select refresh_instrument_risk_metrics();
