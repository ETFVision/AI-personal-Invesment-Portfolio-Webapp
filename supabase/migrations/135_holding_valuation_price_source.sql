-- Anchor holding valuation to the freshest instrument_prices row.
-- instrument_market_metrics remains the source for derived analytics such as previous close and 52-week range.
...
begin
  ...
  latest_prices as (
    select
      target_holdings.*,
      coalesce(latest.close_price, instrument_market_metrics.latest_price, target_holdings.average_cost) as effective_latest_price,
      coalesce(latest.price_date, instrument_market_metrics.latest_price_date) as effective_latest_price_date,
  ...
  select
    ...
    case
      when priced_baselines.weekly_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
    ...
    case
      when priced_baselines.monthly_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
      then priced_baselines.effective_latest_price / priced_baselines.average_cost - 1
    ...
    case
      when priced_baselines.ytd_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
      then priced_baselines.effective_latest_price / priced_baselines.average_cost - 1
    ...
    case
      when priced_baselines.one_year_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
      then priced_baselines.effective_latest_price / priced_baselines.average_cost - 1
    ...
    case
      when priced_baselines.three_year_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
      then priced_baselines.effective_latest_price / priced_baselines.average_cost - 1
    ...
    case
      when priced_baselines.five_year_target_date = priced_baselines.inception_date and priced_baselines.average_cost > 0
      then priced_baselines.effective_latest_price / priced_baselines.average_cost - 1
