-- Update scheduled refreshes for the expanded instrument universe.
--
-- Daily chain:
-- 1. Raw latest instrument prices in five passes, 75 instruments each.
-- 2. Daily returns, return anchors and market metrics as separate derived layers.
-- 3. Benchmarks, portfolio valuation, macro and news refreshes.
--
...
declare
  ...
  job_names text[] := array[
    ...
    'app-temporary-instrument-risk-refresh',
...
-- 6:00-6:40 AM SGT: downstream daily jobs.
select cron.schedule(
  'app-daily-benchmark-refresh',
  '0 22 * * *',
