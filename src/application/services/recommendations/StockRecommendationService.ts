import { buildEvaluation, scoreMarketVisionAlignment, scoreMomentum, scoreRisk, scoreThemeFit, type RecommendationInput } from "./recommendationScoring";
...
export class StockRecommendationService {
  ...
  evaluate(input: RecommendationInput) {
    ...
    const components: ScoreComponent[] = [
      ...
      { key: "market_vision_alignment", label: "Market Vision Alignment", score: scoreMarketVisionAlignment(input), weight: 0.1, reason: "Market Vision context supports the instrument" },
