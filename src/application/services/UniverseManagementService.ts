...
const bondProfiles = [
  ...
  bondProfile("BNDW", "intermediate", "global aggregate", "mixed investment grade", "global", "medium", "moderate negative", "mixed", "global bond diversification", "USD"),
  ...
  bondProfile("IEI", "intermediate", "treasury", "government", "US", "medium", "moderate negative", "positive", "treasury stability", "USD"),
  bondProfile("IEF", "intermediate", "treasury", "government", "US", "medium", "moderate negative", "positive", "recession hedge", "USD"),
  bondProfile("VGIT", "intermediate", "treasury", "government", "US", "medium", "moderate negative", "positive", "treasury stability", "USD"),
  bondProfile("GOVT", "intermediate", "treasury", "government", "US", "medium", "moderate negative", "positive", "treasury stability", "USD"),
  ...
  bondProfile("STIP", "short", "inflation-linked", "government", "US", "low", "positive", "mixed", "short-duration inflation hedge", "USD"),
  bondProfile("LQD", "intermediate", "corporate", "investment grade", "US", "medium", "moderate negative", "negative", "income", "USD"),
  bondProfile("VCIT", "intermediate", "corporate", "investment grade", "US", "medium", "moderate negative", "negative", "investment-grade income", "USD"),
  bondProfile("HYG", "short/intermediate", "high yield", "high yield", "US", "medium", "moderate", "negative", "income with credit risk", "USD"),
  bondProfile("JNK", "short/intermediate", "high yield", "high yield", "US", "medium", "moderate", "negative", "income with credit risk", "USD"),
